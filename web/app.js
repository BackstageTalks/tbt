(() => {
  ...
  async function loadUiConfig() {
    ...
    const [uiResult,telegramResult,runtimeResult,linksResult]=await Promise.allSettled([
      getJSON('/ui-config.json?v=7360&p=41',{timeoutMs:3000}),
      getJSON('/config/telegram-groups.json?v=7360&p=41',{timeoutMs:3000}),
