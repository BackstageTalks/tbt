(() => {
  ...
  function renderAdminRoute(){
    const tabs=[['banners','Banners & links','Top CTA + hlavný banner'],['layout','Prístupy','Viditeľnosť a počty tipov'],['plans','Plány','Členstvá a platobné odkazy'],['accounts','Účty','Roly a prístupy'],['campaigns','Kampane','Reklamné kreatívy'],['analytics','Analytika','Zobrazenia a kliky'],['performance','Model','Kvalita modelu']];
