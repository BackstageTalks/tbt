(() => {
  ...
  function renderAdminRoute(){
    const tabs=[['banners','Bannery a odkazy','Horné CTA + hlavný banner'],['layout','Prístupy','Viditeľnosť a počty tipov'],['plans','Plány','Členstvá a platobné odkazy'],['accounts','Účty','Roly a prístupy'],['campaigns','Kampane','Reklamné kreatívy'],['analytics','Analytika','Zobrazenia a kliky'],['performance','Model','Kvalita modelu']];
    if(!['layout','banners','campaigns','plans','accounts','analytics','performance'].includes(state.adminTab))state.adminTab='banners';
