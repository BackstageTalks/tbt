...
2. Configure Firebase server settings: `FIREBASE_PROJECT_ID`, `FIREBASE_CLIENT_EMAIL`, `FIREBASE_PRIVATE_KEY`.
3. Server-side admin account management uses Firebase Admin SDK. Never expose service-account credentials in `web/`.
