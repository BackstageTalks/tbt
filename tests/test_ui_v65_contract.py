...
def test_v65_dashboard_switches_results_tables_and_future_doubles_feed_are_present():
    ...
    assert "['pro','PRO','More daily picks'" in app
    assert "['elite','ELITE','Deeper access'" in app
    assert "['legend','LEGEND','Maximum access'" in app
