...
def validate_ui_config(payload: object) -> dict:
    ...
    for field, allowed in (("cards_per_panel_desktop", {1, 2, 3}), ("cards_per_panel_wide", {2, 3, 4})):
    ...
    if len(active_pick_windows) != 4:
        raise ValueError("Exactly four pick sections must be enabled on the dashboard")
