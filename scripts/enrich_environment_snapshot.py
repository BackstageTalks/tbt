...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Enrich GitHub history partitions with venue and post-hoc archive weather; Supabase is not used"
    )
    ...
    report: dict[str, Any] = {
        ...
        "weather_policy": "historical archive weather is diagnostic/research only",
